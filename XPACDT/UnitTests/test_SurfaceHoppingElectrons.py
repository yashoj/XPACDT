...
class SurfaceHoppingTest(unittest.TestCase):
    ...
    def test_creation(self):
        params = self.param_classical
        sh_electrons_classical = sh.SurfaceHoppingElectrons(params,
    ...
    def test_energy(self):
        ...
        params["SurfaceHoppingElectrons"]["initial_state"] = 1
        sh_electrons_classical = sh.SurfaceHoppingElectrons(params,
                                                            params["masses"], params["coordinates"],
                                                            params["momenta"])
        np.testing.assert_allclose(sh_electrons_classical.energy(R, centroid=False),
        ...
        # Diabatic basis
        params["SurfaceHoppingElectrons"]["basis"] = 'diabatic'
        params["SurfaceHoppingElectrons"]["initial_state"] = 0
        sh_electrons_classical = sh.SurfaceHoppingElectrons(params,
                                                            params["masses"], params["coordinates"],
                                                            params["momenta"])
        ...
        params = self.param_rpmd
        params["SurfaceHoppingElectrons"]["initial_state"] = 0
        sh_electrons_rpmd = sh.SurfaceHoppingElectrons(params,
                                                       params["masses"], params["coordinates"],
                                                       params["momenta"])
    ...
    def test_get_modified_V(self):
        ...
        params["SurfaceHoppingElectrons"]["basis"] = 'adiabatic'
        params["SurfaceHoppingElectrons"]["rpsh_type"] = 'bead'
        sh_electrons_classical = sh.SurfaceHoppingElectrons(params,
                                                            params["masses"], params["coordinates"],
                                                            params["momenta"])
        ...
        params["SurfaceHoppingElectrons"]["rpsh_type"] = 'centroid'
        sh_electrons_classical = sh.SurfaceHoppingElectrons(params,
                                                            params["masses"], params["coordinates"],
                                                            params["momenta"])
        np.testing.assert_allclose(sh_electrons_classical._get_modified_V(R),
        ...
        params["SurfaceHoppingElectrons"]["rpsh_type"] = 'density_matrix'
        sh_electrons_classical = sh.SurfaceHoppingElectrons(params,
                                                            params["masses"], params["coordinates"],
                                                            params["momenta"])
        np.testing.assert_allclose(sh_electrons_classical._get_modified_V(R),
    ...
    def test_get_H_matrix(self):
        ...
        params["SurfaceHoppingElectrons"]["rpsh_type"] = 'bead'
        params["SurfaceHoppingElectrons"]["evolution_picture"] = 'schroedinger'
        sh_electrons_classical = sh.SurfaceHoppingElectrons(params,
                                                            params["masses"], params["coordinates"],
                                                            params["momenta"])
        ...
        params["SurfaceHoppingElectrons"]["evolution_picture"] = 'interaction'
        sh_electrons_classical = sh.SurfaceHoppingElectrons(params,
                                                            params["masses"], params["coordinates"],
                                                            params["momenta"])
        np.testing.assert_allclose(sh_electrons_classical._get_H_matrix(R, D),
...
#        params = self.param_classical
#        params["SurfaceHoppingElectrons"]["evolution_picture"] = 'schroedinger'
#        params["SurfaceHoppingElectrons"]["n_steps"] = 100
#        #params["TullyModel"]["model_type"] = "model_A"
#        sh_electrons_classical = sh.SurfaceHoppingElectrons(params,
#                                                            params["masses"], params["coordinates"],
#                                                            params["momenta"])
#        
...
#                c_ref, rtol=1e-4)
    ...
    def test_integrator_unitary(self):
        ...
        params = self.param_classical
        params["SurfaceHoppingElectrons"]["ode_solver"] = 'unitary'
        params["SurfaceHoppingElectrons"]["evolution_picture"] = 'interaction'
